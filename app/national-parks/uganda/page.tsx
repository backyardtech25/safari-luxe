...
export default function UgandaNationalParksPage() {
  const parks = [
      ...
      <main className="parks-page">
        <section className="hero">
          <div className="container">
            ...
            <h1 className="hero-title">Uganda National Parks</h1>
            <p className="hero-text">
              Explore Uganda’s finest wildlife parks, gorilla forests,
              scenic reserves, and unforgettable safari destinations.
            </p>
          </div>
        </section>
          ...
          <div className="container">
            <div className="section-head">
              ...
              <p className="section-text">
                Hover over each destination to discover Uganda’s most iconic wildlife experiences.
              </p>
            </div>
              ...
              {parks.map((park, index) => (
                <div key={park} className="park-card">
                  <div
                    ...
                    style={{
                      backgroundImage: `url('/images/national-parks/uganda/${index + 1}.jpg')`,
                    }}
                  >
